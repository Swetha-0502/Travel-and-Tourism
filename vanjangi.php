...
<h2 class="breadcrumb-title">Vanjangi View Point</h2>
...
<h2><center>Vanjangi View Point</center></h2>
<div class="row">
    <center>
    <div class="column">
        <div style="width:1350px;height:700px;margin-left:9%;">
        <img src="/vizagtourism/pictures/vanjangi.jpg" alt="Vanjangi" style="width: 50%;height: 430px;"></a>
        </div>
    </div>
...
<b>Vanjangi Timings:</b>Opens 24hrs<br><br>
<b>Best time to visit:</b>The best time to visit it is from October until the end of February.<br><br>
<img src="/vizagtourism/pictures/location icon.png.png" style="width:20px;height:20px" >&nbsp <b>Place Location:</b>Vanjangi, Paderu, Andhra Pradesh.<br>
...
Paderu APSRTC Bus Station, G. Madugula APSRTC Bus Station, and V. Madugula APSRTC Bus Station are the closest APSRTC Bus Stations to Vanjangi. The APSRTC runs a number of buses to this site from major cities.People who prefer car rides over anything else can opt for this route.<br><br>
<img src="/vizagtourism/pictures/train 1.png" style="width:60px;height:60px;" ><b>By Train:-</b><br><br>
Vanjangi has no railway station within a 10-kilometer radius. However, Anakapalle, a neighboring town, has a railway station, which is adjacent to a number of railway stations.
</div>
