...
<h2 class="breadcrumb-title">Yarada Beach</h2>
...
<h2 style="text-align: center;">Yarada Beach</h2>
<div class="row">
    <center>
    <div class="column">
        <div style="width:1350px;height:700px;margin-left:9%;">
          <img src="/vizagtourism/pictures/yarada beach.jpg" alt="Yarada" style="width: 50%;height: 430px;"></a>
        </div>
    </div>
...
<img src="/vizagtourism/pictures/watch.png" style="height:20px;width:20px"> &nbsp <b style="font-size: 20px;">Yarada Beach Timings:</b>12 am – 12 pm in all days.<br><br>
<img src="/vizagtourism/pictures/distance.png" style="height:20px;width:20px"> &nbsp <b style="font-size: 20px;">Distance(from Railway Station):</b> 14 km <br><br>
...
<img src="/vizagtourism/pictures/location icon.png.png" style="height:20px;width:20px"> &nbsp <b style="font-size: 20px;">Place Location:</b>Hills, Yarada Village, Visakhapatnam (Vizag), India, Vishakhapatnam<br><br>
...
Rushikonda is 11.5 km away from RTC Complex and you can reach there by public transportation like Bus , Auto or by own transport vehicles like cab.<br><br>
<img src="/vizagtourism/pictures/train 1.png" style="width:50px;height:50px;" ><b>By Rail:-</b><br>
Rushikonda is 14km away from vizag railway station.<br><br>
<img src="/vizagtourism/pictures/aeroplane.png" style="width:50px;height:50px;" ><b>By Air:-</b><br>
Rushikonda is 24km away from vizag Airport.<br><br>
</div>
