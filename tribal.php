...
<h2 class="breadcrumb-title">TRIBAL MUSEUM</h2>
...
<h2><b><center>Triabl Museum</center></b></h2>
<div class="row">
    <center>
    <div class="column">
        <div style="width:1350px;height:700px;margin-left:9%;">
         <img src="/vizagtourism/pictures/tribal museum.jpg" alt="tribal" style="width: 50%;height: 410px;">
        </div>
    </div>
...
<b>Best Time to Visit Tribal Museum:</b>The best time to visit the Tribal Museum is in between October to March as the weather would be very pleasant to roam around Araku.<br><br>
<b>Chaparai Waterfalls Ticket Price:</b>
...
The nearest airport is Visakhapatnam which is 19km from Araku. Several cabs ply from the airport to temple.It takes around 45 minutes  <br><br>
<img src="/vizagtourism/pictures/train 1.png" style="width:50px;height:50px;" ><b>By Rail:-</b><br>
The nearest railway station is Visakhapatnam which is 110km from the tribal museum.<br><br>
