...
<h2 class="breadcrumb-title">Borra Caves</h2>
...
<h2><b><center>Borra Caves</center></b></h2>
<div class="row">
    <center>
    <div class="column">
        <div style="width:1350px;height:700px;margin-left:9%;">
          <img src="/vizagtourism/pictures/borra caves 1.jpg" alt="Borra caves" style="width: 50%;height: 400px;">
        </div>
    </div>
...
<h4>Best time to visit</h4><br>
According to the Vizag tourism department, entry is open every day and Borra Caves timings are from 10:00 am – 5:00 pm.  The best time to visit  Borra Caves is between November and March. The weather in these months stays pleasant and is easy to operate as well as roam around the nearby destinations.<br><br>
<h4>Entry Fee</h4>
<table style="width:60%;border-color: #090909;">
  ...
  <tr>
   ...
   <tr>
    <th>For Phone Camera</th>
    <td>Rs 25</td>
    
  </tr>
   <tr>
    <th>For Digital / Still Camera</th>
    <td>Rs 100</td>
    
  </tr>
   <tr>
    <th>For Video Camera</th>
    <td>Rs 100</td>
...
If you wish to take the long road and travel from Bhubaneshwar then the fastest route will be via NH16. The most suitable route is via NH65 and NH16.<br><br>
<img src="/vizagtourism/pictures/aeroplane.png" style="width:60px;height:60px;" ><b>By Air:-</b><br>
Visakhapatnam International Airport is connected by all major flight routes. You can book a taxi or hire a self-drive car to embark on this hilly journey from Visakhapatnam to Borra Caves. <br><br>
<img src="/vizagtourism/pictures/train 1.png" style="width:60px;height:60px;" ><b>By Train:-</b><br>
 Kirandul Train from Visakhapatnam railway station is available.  <br><br>
</div>
