...
<h2 class="breadcrumb-title">Dolphins Nose</h2>
...
<h1><b><center>Dolphins Nose Beach</center></b></h1>
<div class="row">
    <center>
    <div class="column">
        <div style="width:1350px;height:700px;margin-left:9%;">
          <img src="/vizagtourism/pictures/dolphin hill or nose.jpg" alt="RK Beach" style="width: 50%;height: 430px;">
        </div>
    </div>
...
<img src="/vizagtourism/pictures/watch.png" style="height:20px;width:20px"> &nbsp <b style="font-size: 20px;">Dolphins nose beach Timings:</b>3:00 pm – 5:00 pm in all days.<br><br>
<h4>Entry Fee for Dolphins Nose Beach</h4><br>
<table style="width:80%;border-color: #090909;">
  ...
  <tr>
    <th>For Foreigners</th>
    <td>Rs.25 /person</td>
    
  </tr>
  <tr>
    <th>Children (3-11 years)</th>  
    <td>Rs.3 /person </td>
...
<img src="/vizagtourism/pictures/location icon.png.png" style="height:20px;width:20px"> &nbsp <b style="font-size: 20px;">Place Location:</b>Dolphin Hill, Visakhapatnam, Andhra Pradesh<br><br>
...
Dolphins Nose Beachis 3 km away from RTC Complex and you can reach there by public transportation like Bus , Auto or by own transport vehicles like cab.<br><br>
<img src="/vizagtourism/pictures/train 1.png" style="width:50px;height:50px;" ><b>By Rail:-</b><br>
Dolphins Nose Beachis 5km away from vizag railway station.<br><br>
<img src="/vizagtourism/pictures/aeroplane.png" style="width:50px;height:50px;" ><b>By Air:-</b><br>
Dolphins Nose Beachis 20km away from vizag Airport.<br><br>
</div>
